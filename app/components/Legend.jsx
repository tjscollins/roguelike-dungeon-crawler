...
var Legend = () => {
  return (
    <div className="container Legend">
      ...
      <div className="row">
        <div className="hpitem col-xs-12"/>
        <div className="colxs-11">
          <p>
      ...
      <div className="row">
        <div className="weapon col-xs-12"/>
        <div className="colxs-11">
          <p>
      ...
      <div className="row">
        <div className="downstairs col-xs-12"/>
        <div className="colxs-11">
          <p>
      ...
      <div className="row">
        <div className="player-start col-xs-12"/>
        <div className="colxs-11">
          <p>
